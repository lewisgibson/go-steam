...
var file_steammessages_clientlanp2p_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x42, 0x05, 0x48, 0x01, 0x80, 0x01, 0x00,
}
...
func file_steammessages_clientlanp2p_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_steammessages_clientlanp2p_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientlanp2p_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientlanp2p_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientlanp2p_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientlanp2p_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientlanp2p_proto_msgTypes[5].Exporter = func(v any, i int) any {
