...
func file_steammessages_workshop_steamclient_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_steammessages_workshop_steamclient_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_steammessages_workshop_steamclient_proto_msgTypes[1].Exporter = func(v any, i int) any {
