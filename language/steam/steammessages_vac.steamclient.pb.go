...
var file_steammessages_vac_steamclient_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x63, 0x6b, 0x5f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x03, 0x80,
	0x01, 0x01,
}
...
func file_steammessages_vac_steamclient_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_steammessages_vac_steamclient_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_steammessages_vac_steamclient_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_steammessages_vac_steamclient_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_steammessages_vac_steamclient_proto_msgTypes[3].Exporter = func(v any, i int) any {
