...
var file_clientmetrics_proto_rawDesc = []byte{
	...
	0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x52, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x42, 0x05,
...
func file_clientmetrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_clientmetrics_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_clientmetrics_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_clientmetrics_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_clientmetrics_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_clientmetrics_proto_msgTypes[4].Exporter = func(v any, i int) any {
