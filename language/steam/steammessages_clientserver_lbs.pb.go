...
var file_steammessages_clientserver_lbs_proto_rawDesc = []byte{
	...
	0x75, 0x67, 0x63, 0x49, 0x64, 0x42, 0x05, 0x48, 0x01, 0x80, 0x01, 0x00,
}
...
func file_steammessages_clientserver_lbs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_steammessages_clientserver_lbs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_steammessages_clientserver_lbs_proto_msgTypes[8].Exporter = func(v any, i int) any {
